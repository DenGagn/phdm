...
int main(int argc, char *argv[])
{
    ...
    boost::property_tree::ini_parser::read_ini("GrapheneSineDirac.ini", pt);
    ...
    for (id=0; id < y_elem; id++)
    {
        for (id2=0; id2 < x_elem; id2++)
        {
            ...
            graphene::dirac_sine model(xvec[id2],yvec[id],omega,a,E0);
    ...
    graphene::dirac_sine model(0.0,0.0,omega,a,E0);
